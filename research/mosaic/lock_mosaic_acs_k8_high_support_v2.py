#!/usr/bin/env python3
"""Lock the dependency-checked high-support K=8 ACS extension before execution."""
...
OUTPUT = ROOT / "prereg_mosaic_acs_k8_high_support_v2.json"
RECEIPT_ROOT = REPOSITORY / "research/artifacts/mosaic_acs_k8_high_support_v2_receipts"
SUMMARY = REPOSITORY / "research/artifacts/mosaic_acs_k8_high_support_v2_summary.json"
SPECIFICATION = ROOT / "MOSAIC_K8_HIGH_SUPPORT_V2_SPEC.md"
JOBS = (
...
CODE_PATHS = (
    "research/mosaic/lock_mosaic_acs_k8_high_support_v2.py",
    "research/mosaic/run_mosaic_acs_k8_high_support_v2.py",
...
def main() -> None:
    ...
    if args.output.exists() or sidecar.exists() or RECEIPT_ROOT.exists() or SUMMARY.exists():
        raise FileExistsError("K=8 high-support v2 lock or outcome path already exists")
    try:
        import tqdm  # noqa: F401
    except ModuleNotFoundError as exc:
        raise RuntimeError("tqdm is required before this protocol can be locked") from exc
    ...
    payload = {
        "project": "MOSAIC K=8 high-support ACS extension v2",
        "status": "locked_before_execution",
        "analysis_status": "post-review extension; v1 stopped before outcomes because tqdm was unavailable",
