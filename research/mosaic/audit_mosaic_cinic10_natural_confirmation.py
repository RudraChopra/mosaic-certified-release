#!/usr/bin/env python3
"""Audit the locked CINIC-10 natural-origin confirmation artifact."""
...
REPORT = ROOT / "research/artifacts/mosaic_cinic10_natural_v1.json"
OUTPUT = ROOT / "research/artifacts/mosaic_cinic10_natural_v1_audit.json"
...
def main() -> None:
    ...
    checks = {
        "five_registered_seeds": len(rows) == 5,
        ...
        "registered_gate_matches": report["pass"] == (
            len(selected) >= 3
            and all(
                not value["threshold_decisions"]["0.40"][
                    "false_acceptance"
                ]
                for value in selected
            )
    ...
    payload = {
        "name": "MOSAIC CINIC-10 natural-origin audit v1",
