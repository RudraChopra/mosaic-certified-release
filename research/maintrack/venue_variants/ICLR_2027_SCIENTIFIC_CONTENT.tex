...
multiple risks and estimated shift \cite{zollo2024prompt}; joint and
group-conditional certificates further show that finite-family, multi-risk,
and grouped acceptance are not themselves new
\cite{yu2026joint,huang2026conditional}. VERA inherits candidate-wise testing.
