% Style-independent scientific content. Official ICLR 2027 wrapper pending.
% Controlled-study values must be supplied by the shared audited result source.
\providecommand{\ControlledShiftAbstractResult}{The prospectively registered controlled-shift analysis is pending; no fresh outcome is claimed in this source state.}
\providecommand{\ControlledPrimaryResult}{The controlled-shift primary result is pending completion of the locked matrix, receipt audit, and confirmatory replay.}
...
The title retains ``Evidence-Efficient'' only if the frozen literature and
empirical rules permit it.
