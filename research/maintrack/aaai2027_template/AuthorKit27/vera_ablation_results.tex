...
\bottomrule
\end{tabular}
\caption{Prospectively frozen secondary analyses. External safety always uses all four attackers. Candidate alpha and envelope multiplicity remain fixed at the original 12-candidate family, so removing attackers or erasers receives no confidence-allocation windfall.}
\label{tab:ablations}
\end{table*}
