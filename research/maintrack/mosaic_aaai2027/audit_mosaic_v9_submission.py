#!/usr/bin/env python3
"""Fail closed on the MOSAIC v9 anonymous AAAI submission artifacts."""
...
PDFS = {
    "main": HERE / "MOSAIC_AAAI2027_V9_ANONYMOUS.pdf",
    "supplement": HERE / "MOSAIC_AAAI2027_V9_SUPPLEMENT_ANONYMOUS.pdf",
    "checklist": HERE / "MOSAIC_AAAI2027_V9_REPRODUCIBILITY_CHECKLIST.pdf",
}
ARCHIVE = HERE / "MOSAIC_AAAI2027_V9_CODE_DATA_SUPPLEMENT.zip"
OUTPUT = HERE / "MOSAIC_AAAI2027_V9_SUBMISSION_AUDIT.json"
...
def main() -> None:
    ...
    report = {
        "name": "MOSAIC AAAI 2027 v9 submission audit",
