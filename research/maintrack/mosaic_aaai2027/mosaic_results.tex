...
All five preregistered gates passed.  The independent replay recomputed 128,000
...
\begin{figure*}[t]
  ...
  42.1\% of tables, whereas MOSAIC abstains and records no false acceptance.
  Ignoring registered shift is worse.  (b) In the feasible retention cell,
  MOSAIC safely deploys on 56.3\% of tables, compared with 2.5\% for a held-out
...
\textbf{MOSAIC}      &   0.0 &  \textbf{0.0} &  0.0 \\
\hline
...
\textbf{MOSAIC}      &  \textbf{56.3} & 0.0 & \textbf{56.3} \\
\hline
\end{tabular}
...
that MOSAIC avoids and there are no reverse discordances.  The paired rate
difference is 42.1 points (bootstrap 95\% interval $[39.0,45.2]$; exact
McNemar $p=3.69\times10^{-127}$).  Across all eight registered MOSAIC cells,
...
In the retention cell, MOSAIC improves safe deployment over held-out
...
finite-sample contract in this cell.  MOSAIC deployment rises from 0.5\% at
